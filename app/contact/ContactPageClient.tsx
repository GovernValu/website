            ...
            <section className="py-24 bg-white relative">
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
                    ...
                    <div className="space-y-16">
                        ...
                        {/* Offices */}
                        <div className="reveal space-y-10" style={{ transitionDelay: "200ms" }}>
                            {/* Headquarters */}
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    {contactContent.headquarters?.phone && (
                                        <p className="text-gray-600 font-mono text-sm mt-2" dir="ltr">{contactContent.headquarters.phone}</p>
                                    )}
                                </div>
                            </div>

                            {/* International Office */}
                            {contactContent.internationalOffice && (
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 bg-onyx text-brand flex items-center justify-center rounded-full shrink-0">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        <h4 className="text-xl font-serif text-onyx mb-2">{contactContent.internationalOffice?.title}</h4>
                                        <p className="text-gray-600 leading-relaxed font-light whitespace-pre-line">
                                            {contactContent.internationalOffice?.address}
                                        </p>
                                        {contactContent.internationalOffice?.phone && (
                                            <p className="text-gray-600 font-mono text-sm mt-2" dir="ltr">{contactContent.internationalOffice.phone}</p>
                                        )}
                                    </div>
                                </div>
                            )}
