    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-serif text-white">Edit Slide</h1>
                    <p className="text-gray-400 mt-1">Update slide content and settings</p>
                </div>
            </div>
                ...
                <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="0"
                            className="w-32 px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-brand"
                        />
