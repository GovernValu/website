...
export const LABELS = {
    ...
    ar: {
        ...
        whoWeAre: 'من نحن',
        strategicConcept: 'المفهوم الاستراتيجي',
        philosophy: 'فلسفتنا',
        expertise: 'خبراتنا',
        teams: 'فرق العمل',
        ourClients: 'العملاء',
        ...
        howWeWork: 'كيف نعمل',
        readyToDiscuss: 'هل أنت مستعد لمناقشة احتياجاتك في',
        scheduleConsultation: 'تواصل معنا لتحديد موعد مع أحد الاستشاريين لدينا.',
